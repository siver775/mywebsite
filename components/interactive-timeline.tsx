...
const timelineData = [
  {
    ...
    location: "Remote, FL (HQ: San Francisco, CA)",
    description: "Architected full-stack features and internal tooling using Next.js, Node.js, and TypeScript, streamlining cloud infrastructure deployments for developers.",
    technologies: ["Next.js", "Node.js", "TypeScript", "AWS", "PostgreSQL", "Rust"],
    achievements: ["Increased performance by 40%", "Led team of 8 developers", "Architected microservices"],
  },
  {
    id: 2,
    year: "May 2020 – June 2022",
    title: "Senior Full-Stack Engineer",
    company: "Supabase, Inc",
    location: "Remote, FL (HQ: San Francisco, CA)",
    description: "Joined as an early-stage engineer to rebuild enterprise user dashboards using React, Redux, and Go microservices distributed across AWS ECS.",
    technologies: ["React", "Redux", "Python", "Go"],
    achievements: ["Won 3 design awards", "Created viral AR campaign", "Mentored junior developers"],
  },
  {
    id: 3,
    year: "January 2017 – May 2020",
    title: "Full-Stack Engineer",
    company: "LogRocket, Inc.",
    location: "Boston, MA",
    description: "Developed session replay and incident tracking tools using React, Node.js, and Python across AWS EC2 infrastructure.",
    technologies: ["React", "Node.js", "Python", "AWS"],
    achievements: ["Launched 5 products", "Improved UX metrics by 60%", "Built design system"],
  },
  {
    id: 4,
    year: "August 2014 – January 2017",
    title: "Full-Stack Engineer",
